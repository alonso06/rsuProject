            ...
            <table class="table table-striped" id="listados">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $resp->lastname }}</td>
                        <td width="20px">
                            <button class="btn btn-success btn-sm btnEditar" data-id="{{ $resp->id }}"><i
                                    class="fas fa-edit"></i></button>
                        </td>
                        <td width="20px">
                            <form action="{{ route('admin.responsibles.destroy', $resp->id) }}" method="post"
                                class="eliminacion">
                                @csrf
                                @method('delete')
                        ...
                        <td width="20px">
                            <a href="{{ route('admin.responsibles.show', $resp->id) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
